...
import type { AdminCredentials, AdminWithPassword } from
  '../../../models/admin';
...
export const createAdmin =
  async (admin: AdminWithPassword): Promise<AdminCreateValidationSummary> => {
...
export const loginAdmin =
  async (
    credentials: AdminCredentials): Promise<AdminLoginValidationSummary> => {
