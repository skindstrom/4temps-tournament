...
import type { Admin, AdminCredentials, AdminWithPassword } from
  '../models/admin';
...
export const createAdmin =
  async (admin: AdminWithPassword): Promise<boolean> => {
...
export const getAdminFromId =
  async (adminId: ObjectId): Promise<?AdminModel> => {
    try {
...
export const getAdminFromCredentials =
  async (credentials: AdminCredentials): Promise<?AdminModel> => {
