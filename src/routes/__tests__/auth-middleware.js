...
describe('Authentication middleware', () => {
  describe('Allow Role', () => {
    ...
    describe('authenticated', () => {
      ...
      test('Returns 401 is the admin is null and authentication is required', async () => {
        // $FlowFixMe
      ...
      test('Returns 401 is the admin is null, and tournament does not exist and authentication is required', async () => {
        // $FlowFixMe
    ...
    describe('admin', () => {
      ...
      test('404 is returned if tournament does not exist', async () => {
        ...
        await allow('admin')(req, res, () => expect(true).toBe(false));
